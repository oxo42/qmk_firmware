...
#define CSFT_BS LCTL(LSFT(KC_NUBS))
 ...
 * '--------------------------------------------------------------------------------------------------------------------------------------' */
  ...
  { KC_LCTL, CSFT_BS, MO(_FN), KC_LGUI, KC_LALT, KC_SPC,  KC_SPC,  KC_SPC,  KC_RALT, KC_RGUI, KC_HOME, KC_END,  KC_LEFT, KC_DOWN, KC_RGHT },
 },
 ...
 * '--------------------------------------------------------------------------------------------------------------------------------------' */
  ...
  { KC_TRNS, M(0),    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_P7,   KC_P8,   KC_P9,   KC_MINS, KC_TRNS, KC_CAPS, KC_SLCK, KC_PSCR },
