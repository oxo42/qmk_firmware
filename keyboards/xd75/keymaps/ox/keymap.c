 ...
 */
 ...
 [_QW] = { /* QWERTY */
  { KC_EQL,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_MINS, KC_GRV,  KC_EQL,  KC_6,   KC_7,   KC_8,    KC_9,    KC_0,    KC_MINS },
  { TAB_FN,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_LBRC, KC_NUHS, KC_RBRC, KC_Y,   KC_U,   KC_I,    KC_O,    KC_P,    KC_NUBS },
  { CTL_ESC, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_HOME, KC_DEL,  KC_PGUP, KC_H,   KC_J,   KC_K,    KC_L,    KC_SCLN, KC_QUOT },
  { KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_END,  KC_UP,   KC_PGDN, KC_N,   KC_M,   KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT },
  { KC_LCTL, KC_LGUI, KC_LALT, MO(_FN), KC_BSPC, KC_LGUI, KC_LEFT, KC_DOWN, KC_RGHT, KC_ENT, KC_SPC, MO(_FN), KC_RALT, KC_RGUI, KC_RCTL },
 },
